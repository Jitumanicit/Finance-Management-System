	...
	<div class="page-content-wrapper">
		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Dealer
										</div>										
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" method="POST" name="add_staff" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="dealer_name" class="form-control" placeholder="Dealer Name">														
													</div>
												</div>
											</div>
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														...
														<?php foreach ($_VEHICLE_TYPE as $key_vehicle_type => $value): ?>
															<option value="<?php echo $key_vehicle_type;?>"><?php echo $value;?></option>
														<?php endforeach;?>																
														</select>
													</div>
												</div>
...
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`dealer_payment` 
(`dealer_name`, `client_name`, `vehicle type`, `brand`, `model`, `price`, `purchase_date`) 
VALUES 
('$dealer_name', '$client_name', '$vehicle_type', '$brand', '$model', $price, '$date')");
$mysql_insert_dealer->execute();
	...
	VALUES (?, ?, ?, ?, ?, ?, ?,?)");
							...
							header("location:dealer_payment.php");
