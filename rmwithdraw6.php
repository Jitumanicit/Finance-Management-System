...
<?php require_once(dirname(__FILE__).'/sidebar.php');?>	
		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
										...
										<form action="" method="POST" name="add_remuneration" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text"  name="withdraw" class="form-control" placeholder="Enter Salary">
							...
							<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Submit</button>
														<!--<button type="button" class="btn default">Cancel</button>-->
														<a href="rm6.php" class="btn default">Cancel</a>
													</div>
												</div>
											</div>
										</form>
	...
	if(isset($_POST['name']) && isset($_POST['role']) && isset($_POST['withdraw']) && isset($_POST['date']))
	{ 
	$name=$_POST['name'];
	$role=$_POST['role'];
...
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`rm6` 
(`name`, `role`, `withdraw`,`date`) 
VALUES 
('$name', '$role', '$withdraw', '$date')");
...
VALUES 
('$particulars_type','$withdraw','$date','$token_id')");
$mysql_insert_revenue_office->execute();

	header("location:rm6.php");
