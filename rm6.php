			...
			<div class="row">
				<div class="col-md-12 col-sm-12">					
					<div class="portlet box yellow">
						...
						$xyz=datamanager::get_sum_tot('rm6','withdraw','pric');
						foreach ($xyz as $keyxyz);
						echo 'Total='.$keyxyz['pric'].'&nbsp;&nbsp;&nbsp;';
						?>
						
						</div>
							<div align="right" style="padding:12px; font-weight:none; font-size:17px;"><a href="rmwithdraw6.php">Add Remuneration</a></div>
						</div>
						<div class="portlet-body">
							...
							<tbody>
                            <?php
                            $sql2 = $dbhi->prepare("SELECT * FROM rm6 ORDER BY `sl` DESC");
