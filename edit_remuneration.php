...
<?php require_once(dirname(__FILE__).'/sidebar.php');?>	
		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box blue-hoki">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Partner
										</div>										
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" method="POST" name="add_remuneration" class="form-horizontal">	
										<input type="hidden"  name="id" value="<?php echo $key['id'];?>">																			
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<p class="form-control-static"> <?php echo $key['salary'];?> </p>
													</div>
												</div>
											</div>
	...
	$get_id=$_GET['id'];
$mysql_select_dealer = $dbhi2->prepare("SELECT * FROM `finance`.`remunerationn` WHERE `id`=$get_id");
...
$db_dealer_value = $mysql_select_dealer->fetch();
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Remuneration
										</div>										
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" method="POST" name="add_remuneration" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['name']; ?>" type="text" name="name" class="form-control" placeholder="Enter Partner Name">														
													</div>
												</div>
											</div>
                                            <div class="form-body">
...
<input value="<?php echo $db_dealer_value['email']; ?>" type="text" name="email" class="form-control" placeholder="Enter Email">														
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Address</label>
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['address']; ?>" type="text" name="address" class="form-control" placeholder="address">														
													</div>
												</div>
											</div>
											<div class="form-body">
...
<input value="<?php echo $db_dealer_value['salary']; ?>" type="text"  name="salary" class="form-control" placeholder="Enter Salary">														
							...
							<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Update</button>
														<!--<button type="button" class="btn default">Cancel</button>-->
														<a href="remuneration.php" class="btn default">Cancel</a>
													</div>
												</div>
											</div>
										</form>
	...
	if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['address']) && isset($_POST['salary']))
	{ 
	$name=$_POST['name'];
	$phone=$_POST['phone'];
	$email=$_POST['email'];
	...
	*/
$mysql_update_dealer = $dbhi2->prepare("UPDATE `finance`.`remunerationn` 
SET `name`='$name',  
	`phone`=$phone, 
	`email`='$email',
	`address`='$address',
...
WHERE  `id`=$get_id;");
	$mysql_update_dealer->execute();
							...
							header("location:remuneration.php?show_id=$get_id&update=data_sucessfully_updated");
