		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Insurance
										</div>										
									</div>
										...
										<form action="" method="POST" name="add_staff" class="form-horizontal">
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="insurance_company" class="form-control" placeholder="Enter Insurance Company">														
													</div>
												</div>
											</div>
                                            <div class="form-body">
...
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`insurance` 
(`insurance_company`,`agent`,`client_name`, `vehicle_type`,`vehicle_brand`, `vehicle_model`,`reg_no`, `chasis_no`,`premium_year`, `amount_paid`, `date`) 
VALUES 
('$insurance_company', '$agent', '$client_name', '$vehicle_type', '$vehicle_brand', '$vehicle_model','$reg_no','$chasis_no','$premium_year','$amount_paid','$date')");
$mysql_insert_dealer->execute();
	...
	VALUES (?, ?, ?, ?, ?, ?, ?,?)");
							...
							header("location:insurance_payment.php");
