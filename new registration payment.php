		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Registration
										</div>										
									</div>
							...
							<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Submit</button>
														<!--<button type="button" class="btn default">Cancel</button>-->
														<a href="registration_payment.php" class="btn default">Cancel</a>
													</div>
												</div>
											</div>
										</form>
...
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`registration` 
(`client_name`, `vehicle_type`, `model`, `chasis_no`, `amount`, `date`) 
VALUES 
('$client_name', '$vehicle_type', '$model', '$chasis_no', '$amount', '$date')");
