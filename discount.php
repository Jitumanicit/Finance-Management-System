					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								...
								<i class="fa fa-user"></i>Discount Account 
						...
						$xyz=datamanager::get_sum_tot('emi_table','discount','pric');
...
if(isset($_POST['from_date']) && isset($_POST['to_date']))
					...
					$to_date=$to_date;
					$sql2 = $dbhi->prepare("SELECT client.id, client.name, client.address, emi_table.payment_date, emi_table.discount
FROM client
JOIN emi_table
ON client.id=emi_table.client_id WHERE emi_table.discount > 0 AND emi_table.payment_date BETWEEN '$from_date' AND '$to_date'  ORDER BY `id` DESC");
							}
							else
							{
							$sql2 = $dbhi->prepare("SELECT client.id, client.name, client.address, emi_table.payment_date, emi_table.discount
FROM client
JOIN emi_table
ON client.id=emi_table.client_id WHERE emi_table.discount > 0 ORDER BY `id` DESC");
							}		
							$sql2->execute();
