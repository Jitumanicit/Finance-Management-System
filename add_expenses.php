...
<div class="portlet box yellow">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-gift"></i>Add New Expensis
			</div>										
     		</div>
            <div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" method="POST" name="office_expenses" class="form-horizontal">
	...
	*/
	...
	$token_id=md5(time());
$mysql_insert_office = $dbhi->prepare("INSERT INTO `finance`.`office` 
(`item`,`amount`,`date`,`token_id`) 
VALUES 
('$item','$amount','$date','$token_id')");
$mysql_insert_office->execute();

$particulars_type='office_expenses';
...
$mysql_insert_revenue_office->execute();
	...
	VALUES (?, ?, ?, ?, ?, ?, ?,?)");
							...
							header("location:office_expenses.php");
