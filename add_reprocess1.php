		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Reprocess Recive
										</div>
									</div>
										...
										<form action="" method="POST" name="add_staff" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text"  name="amount" class="form-control" placeholder="Enter Amount Recive">
													</div>
												</div>
											</div>
                                            <div class="form-body">
							...
							<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Submit</button>
														<!--<button type="button" class="btn default">Cancel</button>-->
														<a href="reprocess1.php" class="btn default">Cancel</a>
													</div>
												</div>
											</div>
										</form>
...
$token_id=md5(time());
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`reprocess1`
...
$particulars_type='Reprocess_charge_recieved';
...
$mysql_insert_revenue_office->execute();
	...
	VALUES (?, ?, ?, ?, ?, ?, ?,?)");
							...
							header("location:reprocess1.php");
