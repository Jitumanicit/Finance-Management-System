...
<?php require_once(dirname(__FILE__).'/sidebar.php');?>	
	...
	$get_id=$_GET['id'];
$mysql_select_dealer = $dbhi2->prepare("SELECT * FROM `finance`.`insurance_recive` WHERE `id`=$get_id");
...
$db_dealer_value = $mysql_select_dealer->fetch();
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Insurance Recive
										</div>										
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
...
<input value="<?php echo $db_dealer_value['date']; ?>" type="date"  name="date" class="form-control" placeholder="Enter Date">																									
	...
	*/
$mysql_update_dealer = $dbhi2->prepare("UPDATE `finance`.`insurance_recive` 
...
WHERE  `id`=$get_id;");
	$mysql_update_dealer->execute();
							...
							header("location:insurance_recive.php?show_id=$get_id&update=data_sucessfully_updated");
