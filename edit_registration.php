...
<?php require_once(dirname(__FILE__).'/sidebar.php');?>	
	...
	$get_id=$_GET['id'];
$mysql_select_dealer = $dbhi2->prepare("SELECT * FROM `finance`.`registration` WHERE `id`=$get_id");
...
<input value="<?php echo $db_dealer_value['vehicle_type']; ?>" type="text"  name="vehicle_type" class="form-control" placeholder="Enter Vehicle Type">														
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['model']; ?>" type="text"  name="model" class="form-control" placeholder="Enter Vehicle Model">														
													</div>
												</div>
											</div>
...
<input value="<?php echo $db_dealer_value['chasis_no']; ?>" type="text"  name="chasis_no" class="form-control" placeholder="Enter Chasis No">														
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['amount']; ?>" type="text"  name="amount" class="form-control" placeholder="Enter Amount">														
													</div>
												</div>
											</div>
...
<input value="<?php echo $db_dealer_value['date']; ?>" type="date"  name="date" class="form-control" placeholder="Enter Date">																									
									...
									<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Update</button>																		  									<!--<button type="button" class="btn default">Cancel</button>-->
														<a href="registration.php" class="btn default">Cancel</a>
													</div>
												</div>
											</div>
										</form>
										...
										if($_POST)
	{
	if(isset($_POST['client_name']) && isset($_POST['vehicle_type']) && isset($_POST['model']) && isset($_POST['chasis_no']) && isset($_POST['amount']) && isset($_POST['date']))
	{ 
	...
	*/
$mysql_update_dealer = $dbhi2->prepare("UPDATE `finance`.`registration` 
...
WHERE  `id`=$get_id;");
	$mysql_update_dealer->execute();
							...
							header("location:registration_payment.php?show_id=$get_id&update=data_sucessfully_updated");
