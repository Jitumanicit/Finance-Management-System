		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Remuneration
										</div>										
									</div>
...
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`remunerationn` 
(`name`, `phone`, `email`, `address`, `salary`) 
VALUES 
('$name', '$phone', '$email','$address', '$salary')");
$mysql_insert_dealer->execute();
	...
	VALUES (?, ?, ?, ?, ?, ?, ?,?)");
							...
							header("location:remuneration.php");
