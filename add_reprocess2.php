		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Reprocess
										</div>
									</div>
...
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`reprocess2`
...
$particulars_type='Reprocess_boy_payment';
...
$mysql_insert_revenue_office->execute();
	...
	VALUES (?, ?, ?, ?, ?, ?, ?,?)");
							...
							header("location:reprocess2.php");
