		...
		<?php  if(isset($_GET['edit'])){
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add Collection Payment
										</div>
									</div>
							...
							<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Submit</button>
														<!--<button type="button" class="btn default">Cancel</button>-->
														<a href="colllection_payment.php" class="btn default">Cancel</a>
													</div>
												</div>
											</div>
										</form>
...
$mysql_insert_dealer = $dbhi->prepare("INSERT INTO `finance`.`collection1`
...
$particulars_type='Collection_Payment_Account';
...
$mysql_insert_revenue_office->execute();
	...
	VALUES (?, ?, ?, ?, ?, ?, ?,?)");
							...
							header("location:collection_payment.php");
