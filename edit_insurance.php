...
<?php require_once(dirname(__FILE__).'/sidebar.php');?>	
	...
	$get_id=$_GET['id'];
$mysql_select_dealer = $dbhi2->prepare("SELECT * FROM `finance`.`insurance` WHERE `id`=$get_id");
...
$db_dealer_value = $mysql_select_dealer->fetch();
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Insurance
										</div>										
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" method="POST" name="add_staff" class="form-horizontal">
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['insurance_company']; ?>" type="text" name="insurance_company" class="form-control" placeholder="Enter Insurance Company">														
													</div>
												</div>
											</div>
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['agent']; ?>" type="text" name="agent" class="form-control" placeholder="Enter Agent">														
													</div>
												</div>
											</div>										
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['client_name']; ?>" type="text" name="client_name" class="form-control" placeholder="Enter Client Name">														
													</div>
												</div>
											</div>
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['vehicle_type']; ?>" type="text"  name="vehicle_type" class="form-control" placeholder="Enter Vehicle Type">														
													</div>
												</div>
											</div>
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['vehicle_brand']; ?>" type="text"  name="vehicle_brand" class="form-control" placeholder="Enter Vehicle Brand">														
													</div>
												</div>
											</div>
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['vehicle_model']; ?>" type="text"  name="vehicle_model" class="form-control" placeholder="Enter Vehicle Model">														
													</div>
												</div>
											</div>
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['reg_no']; ?>" type="text"  name="reg_no" class="form-control" placeholder="Enter Registration No">														
													</div>
												</div>
											</div>
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['chasis_no']; ?>" type="text"  name="chasis_no" class="form-control" placeholder="Enter Chasis No">														
													</div>
												</div>
											</div>
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['premium_year']; ?>" type="text"  name="premium_year" class="form-control" placeholder="Enter Premium Year">														
													</div>
												</div>
											</div>
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['amount_paid']; ?>" type="text"  name="amount_paid" class="form-control" placeholder="Enter Amount Paid">														
													</div>
												</div>
											</div>
...
<input value="<?php echo $db_dealer_value['date']; ?>" type="date"  name="date" class="form-control" placeholder="Enter Date">																									
	...
	{
	if(isset($_POST['insurance_company']) && isset($_POST['agent']) && isset($_POST['client_name']) && isset($_POST['vehicle_type'])&& isset($_POST['vehicle_brand']) && isset($_POST['vehicle_model']) && isset($_POST['reg_no'])&& isset($_POST['chasis_no']) && isset($_POST['premium_year']) && isset($_POST['amount_paid']) && isset($_POST['date']))
	{ 
	...
	*/
$mysql_update_dealer = $dbhi2->prepare("UPDATE `finance`.`insurance` 
SET `insurance_company`='$insurance_company',
	`agent`='$agent',
...
WHERE  `id`=$get_id;");
	$mysql_update_dealer->execute();
							...
							header("location:insurance_payment.php?show_id=$get_id&update=data_sucessfully_updated");
