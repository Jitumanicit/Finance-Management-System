...
<?php require_once(dirname(__FILE__).'/sidebar.php');?>	
	...
	$get_id=$_GET['id'];
$mysql_select_dealer = $dbhi2->prepare("SELECT * FROM `finance`.`dealer_payment` WHERE `id`=$get_id");
...
$db_dealer_value = $mysql_select_dealer->fetch();
			...
			<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Dealer
										</div>										
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" method="POST" name="add_staff" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['dealer_name']; ?>" type="text" name="dealer_name" class="form-control" placeholder="Dealer Name">														
													</div>
												</div>
											</div>
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['client_name']; ?>" type="text"  name="client_name" class="form-control" placeholder="Client Name">														
													</div>
												</div>
											</div>
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														...
														<?php foreach ($_VEHICLE_TYPE as $key_vehicle_type => $value): ?>
<option value="<?php echo $key_vehicle_type; ?>" <?php if(strtolower($db_dealer_value['vehicle type']) == $key_vehicle_type) { echo 'selected="selected"'; }?>><?php echo $value;?></option>
														<?php endforeach;?>																
														</select>
													</div>
												</div>
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['brand']; ?>" type="text"  name="brand" class="form-control" placeholder="Brand">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['model']; ?>" type="text"  name="model" class="form-control" placeholder="Model">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input type="text" value="<?php echo $db_dealer_value['price']; ?>"  name="price" class="form-control" placeholder="Price">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['purchase_date']; ?>" type="date"  name="purchase_date" class="form-control" placeholder="Purchase Date">																									
													</div>
												</div>
											</div>
											<div class="form-actions fluid">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
							<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Update</button>
														<!--<button type="button" class="btn default">Cancel</button>-->
														<a href="dealer_payment.php" class="btn default">Cancel</a>
													</div>
												</div>
											</div>
										</form>
	...
	if(isset($_POST['dealer_name']) && isset($_POST['client_name']) && isset($_POST['brand']) && isset($_POST['model']) && isset($_POST['price']))
	{ 
	...
	*/
$mysql_update_dealer = $dbhi2->prepare("UPDATE `finance`.`dealer_payment` 
...
WHERE  `id`=$get_id;");
	$mysql_update_dealer->execute();
							...
							header("location:dealer_payment.php?show_id=$get_id&update=data_sucessfully_updated");
